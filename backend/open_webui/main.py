...
app.state.config.ENABLE_UPLOADS = ENABLE_UPLOADS
...
app.include_router(saved_items.router, prefix="/api/v1/saved-items", tags=["saved-items"])
            ...
            **(
                {
                    ...
                    "enable_uploads": app.state.config.ENABLE_UPLOADS,
